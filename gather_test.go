...
func TestSTUNConcurrency(t *testing.T) {
	...
	require.NoError(t, err)
	serverPort := listenerPort(t, serverListener.LocalAddr())
...
func TestTURNConcurrency(t *testing.T) {
	...
	t.Run("TCP Relay", func(t *testing.T) {
		...
		require.NoError(t, err)
		serverPort := listenerPort(t, serverListener.Addr())
...
func TestGatherCandidatesRelayProducesRelay(t *testing.T) {
	...
	serverPort := listenerPort(t, listener.LocalAddr())
	turnURL := &stun.URI{
		Scheme:   stun.SchemeTypeTURN,
		Host:     "127.0.0.1",
		Port:     serverPort,
...
func TestMultiUDPMuxUsage(t *testing.T) {
	...
	for i := range 3 {
		...
		expectedPorts = append(expectedPorts, listenerPort(t, conn.LocalAddr()))
...
func TestMultiTCPMuxUsage(t *testing.T) {
	...
	for range 3 {
		...
		expectedPorts = append(expectedPorts, listenerPort(t, listener.Addr()))
