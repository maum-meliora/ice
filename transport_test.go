...
// listenerPort returns the port of a listener address, so tests can bind to
// port 0 and read the assigned port back instead of guessing a free one.
func listenerPort(tb testing.TB, addr net.Addr) int {
	tb.Helper()
